                        ...
                        <div className="container-fluid bg-light border shadow">
                            <div className="row">
                                <div className="col-12 col-md-4 p-0">
                                    <div className="card border-0 bg-transparent">
                                        <div className="card-body text-center p-4 p-xxl-5">
                                            <h3 className="display-6 fw-bold mb-2">Telefono</h3>
                                            <p className="fs-5 mb-0 text-secondary">+54 221 5923513</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 col-md-4 p-0 border-top border-bottom border-start border-end">
                                    <div className="card border-0 bg-transparent">
                                        <div className="card-body text-center p-4 p-xxl-5">
                                            <h3 className="display-6 fw-bold mb-2">Correo</h3>
                                            <p className="fs-5 mb-0 text-secondary">consultarmear@gmail.com</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 col-md-4 p-0">
                                    <div className="card border-0 bg-transparent">
                                        <div className="card-body text-center p-4 p-xxl-5">
                                            <h3 className="display-6 fw-bold mb-2">Horario</h3>
                                            <p className="fs-5 mb-0 text-secondary">Lunes a viernes de 8:30 a 16:30 Hs</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
